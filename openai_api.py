...
if __name__ == "__main__":
    ...
    #     "D:\work\ChatGLM2-6B\model", trust_remote_code=True, pre_seq_len=128)
    #
    # prefix_state_dict = torch.load(os.path.join(
    #     "D:/work/ChatGLM2-6B/ptuning/output/adgen-chatglm2-6b-pt-LR1/checkpoint-1000", "pytorch_model.bin"))
